...
<?php for($i=0;$i<count($images);$i++):?>
	<li class="span2">
		...
		<input type="text" name="caption" class="image-caption" value="<?=$images[$i]['caption'];?>" /><button data-item="<?=$images[$i]['id'];?>" class="btn btn-info btn-image-caption"><i class="icon-ok"></i></button>
	</li>
<?php endfor;?>
</ul>